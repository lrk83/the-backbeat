   ...
   useEffect(() => {
    ...
    return (
        <div className="three-suggestions" data-aos="fade-in" data-aos-delay="100" data-aos-duration="1500">
            ...
            <Header as='h4' id="secondary-creatives-title">Some of the best content we have to offer</Header>
            {sortedSkillData[0] &&
            <Container className="three-suggestions-container">
                {cardsToShow.map((number)=> 
                    <Link key={number} className="three-suggestions-link" to={`/skills/single-skill/${sortedSkillData[number]._id}`}>
                        <Card>
