...
import SmallCurrentUserSlide from '../small-screen/small-current-user-slides';
   ...
   useEffect(() => {
    ...
    return (
        <div className="three-suggestions" data-aos="fade-in" data-aos-delay="100" data-aos-duration="1500">
            ...
            {sortedSkillData[0] &&
            <Slides data={sortedSkillData}></Slides>}
        </div>
    )
}
